  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ t.category }}</td>
        <td>
          <form method="post" action="{{ url_for('delete_transaction', id=t.id) }}" style="margin:0;">
...
class Transaction(db.Model):
    ...
    expense_category = db.Column(db.String(20), default="")
...
def add_transaction():
    ...
    new_transaction = Transaction(date=date, category=category, expense_category=expense_category, amount=amount)
